# Sistemática de Avaliação — DIM0510 Processos de Software
...
Grupos que integrarem este projeto com os de Web II (DIM0547) ou Sistemas Móveis (DIM0524) recebem acréscimo de 15% na nota de cada sprint, limitado a 10,0.

Condições: declaração na Sprint 0; produto comum com repositórios vinculados nos READMEs; contribuição desta disciplina distinguível — os artefatos de processo são exclusivos daqui; integração ativa durante toda a sprint avaliada.
...
| Prova | Conteúdo |
|-------|----------|
| Prova escrita, obrigatória | Sprints 0 a 2: modelos de ciclo de vida, Manifesto Ágil, Scrum, backlog e estimativa, XP, Lean, Kanban, métricas de fluxo, DevOps, CI/CD, Docker e métricas DORA |
| Prova de reposição, opcional | Todo o conteúdo da primeira prova, acrescido da Sprint 3: Mapeamento de Fluxo de Valor, controle de qualidade, inspeções, medição de processo e modelos de maturidade |
